      ...
      <section className="abans-hero">
        <div className="abans-hero-text">
          ...
          <p className="abans-hero-subtitle">
            ...
            <br />
            Motorola by Abans has joined NLDS 2024 as the Official Mobile
            Partner. In collaboration with Abans Group, Motorola brings
            cutting-edge technology to inspire and empower tomorrow’s leaders.
            <br />
            <br />
            <b>A Legacy of Innovation</b>
            <br />
            Motorola has been at the forefront of mobile technology for decades.
            From providing the communication equipment for the Apollo 11 mission
            that helped astronauts relay the first-ever words from the moon, to
            revolutionizing the mobile industry with the world’s first flip
            mobile phones, Motorola continues to pioneer cutting-edge
            innovations.
            <br />
            <br />
            <b>Your Go-To for Genuine Motorola Devices</b>
            <br />
            Through Abans, the trusted reseller of Motorola in Sri Lanka,
            Motorola ensures you access to their latest technology. With trusted
            after-sales support and guaranteed authenticity, you can purchase
            your next Motorola device with confidence.
          </p>
