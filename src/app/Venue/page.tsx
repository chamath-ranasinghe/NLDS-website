    ...
    <div className="venue-container">
      ...
      <div className="venue-content">
        ...
        <div className="venue-details">
          ...
          <p>
            The conference will be held at the stunning XYZ Conference Center,
            located in the heart of the city. With state-of-the-art facilities
            and breathtaking views, this venue provides the perfect backdrop for
            our three-day event. You'll have access to world-class amenities,
            breakout rooms, and an exciting atmosphere for networking.
          </p>
