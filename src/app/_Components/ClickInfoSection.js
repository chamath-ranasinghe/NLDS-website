...
function ClickInfoSection() {
  return (
    <section className="click-info-section">
      ...
      <p></p>
      <p className="click-info-text prices">
        Standard Pack: Tshirt + Band + Sticker Pack + Mystery Gift{" "}
      </p>
      <p className="click-info-text prices">
        Skinny <span style={{ color: "#f00" }}> Limited Edition </span>{" "}
      </p>
      <p className="click-info-text prices">
        Cap <span style={{ color: "#f00" }}> Limited Edition </span>
      </p>
